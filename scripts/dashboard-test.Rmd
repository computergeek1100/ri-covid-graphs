...
```{r}
vb_hosp(state_cleaned$currentHosp, state_cleaned$percentChange_hosp)
```

### ICU (vs Last Week)

```{r}
vb_hosp(state_cleaned$ICU, state_cleaned$percentChange_ICU)
```

### Ventilator (vs Last Week)

```{r}
vb_hosp(state_cleaned$vent, state_cleaned$percentChange_vent)
```
