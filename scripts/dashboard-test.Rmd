...
```{r}
valueBox(value = paste0(tail(state_cleaned$Last7Days_100k, 1), " (7 Days Ago: ", (state_cleaned$Last7Days_100k[nrow(state_cleaned) - 7]), ")"), color=ifelse(tail(state_cleaned$Last7Days_100k, 1) < state_cleaned$Last7Days_100k[nrow(state_cleaned) - 7], "success", "danger"), icon=ifelse(tail(state_cleaned$Last7Days_100k, 1) < state_cleaned$Last7Days_100k[nrow(state_cleaned) - 7], "fa-arrow-down", "fa-arrow-up"))
```
...
```{r}
valueBox(value = paste0(tail(state_cleaned$Avg7Day_totalDosesPriorDay, 1), " (7 Days Ago: ", (state_cleaned$Avg7Day_totalDosesPriorDay[nrow(state_cleaned) - 7]), ")"), color=ifelse(tail(state_cleaned$Avg7Day_totalDosesPriorDay, 1) < state_cleaned$Avg7Day_totalDosesPriorDay[nrow(state_cleaned) - 7], "danger", "success"), icon=ifelse(tail(state_cleaned$Avg7Day_totalDosesPriorDay, 1) < state_cleaned$Avg7Day_totalDosesPriorDay[nrow(state_cleaned) - 7], "fa-arrow-down", "fa-arrow-up"))
```
