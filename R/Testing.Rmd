...
```{r}
totalDose1 <- remDr$findElement(using='xpath','/html/body/app-bootstrap/ng2-bootstrap/bootstrap/div/div/div/div/div/div[1]/div[2]/div/div[1]/div[1]/div[1]/div/lego-report/lego-canvas-container/div/file-drop-zone/span/content-section/div[36]/canvas-component/div/div/div[1]/div/div/kpimetric/div/div[2]')
...
```{r}
ggplot(vaxDataCleaned, aes(date, dose1PriorDay))+geom_col()+labs(title="People vaccinated per day (First Dose Only)\nMondays include weekend data")
```
