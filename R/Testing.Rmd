...
```{r}
vaxData <- data.frame(date=c("Dec 17, 2020", "Dec 18, 2020", "Dec 21, 2020", "Dec 22, 2020"), totalVaccinated=c("0", "1,226","4,827","6,400")) # initialize original df in case of issues
```
